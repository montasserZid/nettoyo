...
function TimeStepControl({
  ...
  return (
    <div
      className={`inline-flex items-center gap-2 rounded-lg border border-[#E5E7EB] bg-white px-2.5 py-2 shadow-sm ${
        disabled ? 'opacity-50' : ''
      }`}
    >
...
export function CleanerDashboardPage() {
  ...
  return (
    <div className="min-h-[calc(100vh-160px)] bg-[#F7F7F7] px-4 py-6 sm:px-6 sm:py-8 lg:px-8">
      <div className="mx-auto max-w-7xl">
        ...
        <section className="mb-6 rounded-2xl bg-white p-6 shadow-[0_4px_16px_rgba(17,24,39,0.04)] sm:mb-8 sm:p-8">
          <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
            ...
            <div className="inline-flex shrink-0 items-center gap-2 self-start rounded-full border border-[#A8E6CF] bg-[rgba(168,230,207,0.15)] px-3 py-2 text-xs font-semibold text-[#1A1A2E] sm:px-4 sm:text-sm">
              <UserCircle2 size={16} className="shrink-0" />
              <span className="truncate max-w-[200px] sm:max-w-none">{displayName}</span>
            </div>
          </div>
        </section>

        <div className="grid gap-6 lg:grid-cols-[minmax(280px,320px),1fr] lg:gap-8">
              ...
              <div className="border-t border-[#E5E7EB] bg-[#FAFBFC] p-5 sm:p-6">
                <div className="space-y-3">
                  {weekdayOrder.map((day) => {
                    ...
                    return (
                      <div key={day} className="overflow-hidden rounded-xl border border-[#E5E7EB] bg-white">
                        <div className="p-4">
                          <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                            ...
                            {value.enabled ? (
                              <div className="flex flex-wrap items-center gap-2 sm:gap-3">
                                <label className="flex-1 min-w-[140px] sm:flex-initial">
        ...
        <section className="sticky bottom-0 z-40 mt-6 overflow-hidden rounded-2xl border border-[#E5E7EB] bg-white shadow-[0_-4px_24px_rgba(17,24,39,0.08)]">
          <div className="p-4 sm:p-5">
            <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
              <div className="flex-1 min-w-0">
